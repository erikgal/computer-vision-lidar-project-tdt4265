...
class DeeperRegHeads(nn.Module):
    def __init__(self,
    ...
    def regress_boxes(self, features):
        ...
        for idx, x in enumerate(features):
            ...
            bbox_conf = self.classification_heads[idx](
                x).view(x.shape[0], self.num_classes, -1)
    ...
    def forward_test(self,
        ...
        boxes_ltrb, confs = self.anchor_encoder.decode_output(
            bbox_delta, confs)
        predictions = []
...
def filter_predictions(
    ...
    keep_idx = batched_nms(boxes_ltrb, scores, category,
